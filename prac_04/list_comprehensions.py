...
# Expectation: ['bob martin', 'angel harlem', 'jimi hendrix', 'alan turing', 'ada lovelace']
print([lowercase_name.lower() for lowercase_name in full_names])

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
numbers = [int(number) for number in almost_numbers]
# Expectation: [0, 10, 21, 3, -7, 88, 9]
print(numbers)
# Expectation: [10, 21, 88]
